...
import { re } from "@vue/test-utils/dist/vue-test-utils";
  ...
  methods: {
    ...
    submitForm(formName) {
      this.$refs[formName].validate((valid) => {
        if (valid) {
          let params = {
            displayName: this.ruleForm2.displayName,
            loginName: this.ruleForm2.loginName,
            loginPassword: encrypt(this.ruleForm2.pass),
            userDetail: {
              phone: this.ruleForm2.tel,
              email: this.ruleForm2.email,
              realName: this.ruleForm2.displayName,
            },
          };
